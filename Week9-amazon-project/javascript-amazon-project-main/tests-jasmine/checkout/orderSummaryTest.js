...
describe('test suite: renderCartSummary', ()=>{
  ...
  it('displays the cart', ()=>{
    ...
    expect(document.querySelector(`.js-product-${productId1}`).innerText).toEqual('Black and Gray Athletic Cotton Socks - 6 Pairs');
    expect(document.querySelector(`.js-product-${productId2}`).innerText).toEqual('Intermediate Size Basketball');
  ...
  afterEach(()=>{
    ...
    it('updates delivery option', ()=>{
     ...
     document.querySelector(`.js-product-${productId1}.js-delivery-option-3`).click();
             
      expect(document.querySelector(`.js-product-${productId1}.js-delivery-option-3`).checked).toBe(true);
